...
@section('content')
 <div class="breadcumb-wrapper" data-bg-src="assets/img/breadcumb/breadcumb-bg-2.jpg">
        ...
        <div class="container">
            <div class="row justify-content-between gx-0">
                ...
                <div class="col-auto mb-5 mb-md-0">
                    <div class="pt-1 mt-2">
                        <div class="circle-btn style2"><a href="service.html" class="btn-icon"><i
    ...
    <section class="space-top space-extra-bottom">
        ...
        <div class="container">
            <div class="title-area text-center"><span class="sec-subtitle">client testimonial</span>
                ...
                <div class="vs-carousel" data-slide-show="1" data-fade="true" data-arrows="true" data-ml-arrows="true"
                    ...
                    <div>
                        ...
                        <div class="arrow-shape"><i class="arrow"></i><i class="arrow"></i><i class="arrow"></i><i
                                class="arrow"></i></div>
                        <h3 class="testi-name h5">Thomas Muller</h3><span class="testi-degi">CEO, SPATHINK</span>
                    </div>
                    <div>
