...
<div class="breadcumb-wrapper" data-bg-src="assets/img/breadcumb/breadcumb-bg-4.jpg">
    <div class="container z-index-common">
        <div class="breadcumb-content">
            <h1 class="breadcumb-title">Eye Lash <span class="inner-text">Extension</span></h1>
...
<section class="services-section space-top space-bottom space-extra-bottom">
    <div class="container">
        <div class="section-title">
            <h2>Our <span class="inner-text">Eye Lash Extension</span></h2>
