                    ...
                    <div class="col-md-6 col-lg-5 col-xxl-auto">
                        <div class="service-style1 reverse">
                            ...
                            <div class="service-content">
                                <h3 class="service-title"><a href="/services-details" class="text-inherit">Discover
                                        New</a></h3>
                        ...
                        <div class="service-style1 reverse">
                            ...
                            <div class="service-content">
                                <h3 class="service-title"><a href="/services-details" class="text-inherit">Eye &
                                        Shadow</a></h3>
                                <p class="service-text">There are many variations of passages gaks the majority.</p>
                            </div>
                        </div>
                        <div class="service-style1 reverse">
                            ...
                            <div class="service-content">
                                <h3 class="service-title"><a href="/services-details" class="text-inherit">Relaxation
                                        Room</a></h3>
                                <p class="service-text">There are many variations of passages gaks the majority.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col col-xxl-auto text-center d-none d-lg-block"><img
                            src="assets/img/bg/sr-shape-1-1.png" alt="shape" class="mt-n4"></div>
                    <div class="col-md-6 col-lg-5 col-xxl-auto">
                        <div class="service-style1">
                            <div class="vs-icon"><img src="assets/img/icon/sr-i-1-4.png" alt="icon"></div>
                            <div class="service-content">
                                <h3 class="service-title"><a href="/services-details" class="text-inherit">Thermal
                                        Bath</a></h3>
                                <p class="service-text">There are many variations of passages gaks the majority.</p>
                            </div>
                        </div>
                        <div class="service-style1">
                            ...
                            <div class="service-content">
                                <h3 class="service-title"><a href="/services-details" class="text-inherit">Stone
                                        Massage</a></h3>
                                <p class="service-text">There are many variations of passages gaks the majority.</p>
                            </div>
                        </div>
                        <div class="service-style1">
                            ...
                            <div class="service-content">
                                <h3 class="service-title"><a href="/services-details" class="text-inherit">Parlar &
                                        Beauty</a></h3>
                                <p class="service-text">There are many variations of passages gaks the majority.</p>
                            </div>
                        </div>
    ...
    <section class="space-top space-extra-bottom">
        ...
        <div class="container">
            <div class="row flex-row-reverse gx-55">
                <div class="col-md-6 col-lg-6 col-xl-4 col-xxl align-self-end mb-40 mb-md-0 wow fadeInUp"
                    data-wow-delay="0.2s">
                    <div class="img-box3 style2">
                        ...
                        <div class="img-product"><a href="shop-details.html"><img src="assets/img/about/price-2-1-1.png"
                                    alt="about"></a>
                            <p class="product-title"><a href="shop-details.html" class="text-inherit">face vitamin</a>
                            </p>
                ...
                <div class="col-md-6 col-lg-6 col-xl-8 col-xxl-auto wow fadeInUp" data-wow-delay="0.3s">
                    <div class="title-area text-center text-md-start"><span class="text-white sec-subtitle">Experience
                            Wellnez <span class="sec-subtext bg-theme">25 Years</span></span>
    ...
    <section class="overflow-hidden space-top space-extra-bottom">
        ...
        <div class="container">
            <div class="row gx-55">
                ...
                <div class="col-lg-7 col-xxl align-self-center wow fadeInUp" data-wow-delay="0.3s"><span
                    ...
                    <div class="row gx-25">
                        <div class="col-md-6">
                            <div class="feature-style1">
                                ...
                                <h3 class="feature-title h5"><a class="text-inherit" href="/services-details">Body
                                        Treatments</a></h3>
                                <div class="arrow-shape"><i class="arrow"></i><i class="arrow"></i><i
                                        class="arrow"></i><i class="arrow"></i></div>
                                <p class="feature-text">There many variations passages Ipsum availle majority have
                                    suffered in some.</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="feature-style1">
                                ...
                                <h3 class="feature-title h5"><a class="text-inherit" href="/services-details">Stone
                                        Massage</a></h3>
                                <div class="arrow-shape"><i class="arrow"></i><i class="arrow"></i><i
                                        class="arrow"></i><i class="arrow"></i></div>
                                <p class="feature-text">There many variations passages Ipsum availle majority have
            ...
            <div class="row justify-content-center">
                <div class="col-auto wow fadeInUp" data-wow-delay="0.2s">
                    <div class="img-box4" data-overlay="theme" data-opacity="4">
                        <div class="img-1"><img src="assets/img/about/cta-video-2-1.jpg" alt="thumbnail" class="w-100">
                        </div>
                        <div class="img-2 jump"><img src="assets/img/shape/shape-dotted.png" alt="shape"></div>
                        <div class="img-3 jump"><img src="assets/img/shape/shape-dotted.png" alt="shape"></div><a
                            href="https://www.youtube.com/watch?v=_sI_Ps7JSEk"
                            class="watch-btn style2 popup-video"><span class="play-btn"><i
                                    class="fas fa-play"></i></span> <span class="btn-text">Watch Our Story</span></a>
                    </div>
                </div>
            </div>
        </div>
